...
const CURRICULUM = [
  ...
  { chapter: 'chapter7', desc: 'chapter7Desc', topics: 'chapter7Topics', problems: ['doubly-linked-list', 'queue-basics', 'stack-calculator', 'bubble-sort', 'quick-sort', 'memory-pool', 'hash-table', 'binary-tree'] },
];
